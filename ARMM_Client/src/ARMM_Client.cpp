...
//Keyboard controller
#include "KeyboardControls_client.h"
...
{		
	...
	// set camera index to 1 to test on one PC Environment
	// if this system can separate server and client on other PCs,
	// you can delete argument 1
...
//	ARMM_Client = new vrpn_Tracker_Remote ("ARMM_Comm", m_Connection);
	...
	//----->Client part
	ARMMClient *armm_client = new ARMMClient (ARMM_SERVER_IP);
